...
DEF_REPORT_SEQUENCE_NAMED(RALT_AND_4,    	        DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_4));
DEF_REPORT_SEQUENCE_NAMED(RALT_AND_5,    	        DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_5));
